...
do
    ...
    function Funcs:AddLabel(Text, DoesWrap)
        ...
        local TextLabel = Library:CreateLabel({
            ...
            TextXAlignment = Enum.TextXAlignment.Center; -- def is left lol.
            ZIndex = 5;
            Parent = Container;
        });
    ...
    function Funcs:AddToggle(Idx, Info)
        ...
        ToggleRegion.InputBegan:Connect(function(Input)
            if (Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch) and not Library:isHolding(ToggleRegion) and not Library:MouseIsOverOpenedFrame() then
        ...
        function Dropdown:BuildDropdownList()
            ...
            for Idx, Value in next, Values do
                ...
                ButtonLabel.InputBegan:Connect(function(Input)
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch and not Library:isHolding(ButtonLabel) then
...
function Library:CreateWindow(...)
    ...
    function Window:AddTab(Name)
        ...
        local LeftSide = Library:Create('ScrollingFrame', {
            ...
            Size = UDim2.new(0.5, -12 + 2, 1, 2); -- UDim2.new(0.5, -12 + 2, 0, 507 + 2)
            CanvasSize = UDim2.new(0, 0, 0, 0);
            BottomImage = '';
            TopImage = '';
